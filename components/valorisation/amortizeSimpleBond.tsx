...
const AmortizedSimpleBond = () => {
  ...
  return (
    <GeneralLayout
      title="Amortized Simple Bond Valuation"
      bred={<CustomBreadcrumb name="Amortized Simple Bond Valuation" />}
    >
              ...
              <div className="flex justify-between items-center gap-4">
                <FormField
                  ...
                  render={({ field }) => {
                    return (
                      <FormItem className="w-1/2">
                        <FormLabel>Amortization Frequency</FormLabel>
                        <Select
                          onValueChange={field.onChange}
                          defaultValue={field.value}
                        >
...
export default AmortizedSimpleBond;
