...
const AmeOption = ({ countries, currencies }: AmeOptionProps) => {
  ...
  const form = useForm<z.infer<typeof AmericSchema>>({
    resolver: zodResolver(AmericSchema),
    defaultValues: {
 ...
 */
  ...
  const procesForm = async (values: z.infer<typeof AmericSchema>) => {
    ...
    const dcurve = await computeAmeOptionDiscountCurve(
      values,
      disc,
      yieldcurve,
      zcrates,
    ...
    let tmp;
    const global = await computeGeneralAmericanOption(
      values,
      dcurve?.data,
      volatility,
      dividend
  ...
  return (
    <GeneralLayout
      title="American Option Valuation"
      bred={<CustomBreadcrumb name="American Option Valuation" />}
    >
                            ...
                            <FormItem className="w-1/2">
                              ...
                              >
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="Binomial Tree">
                                    Binomial Tree
                                  </SelectItem>
                                </SelectContent>
                              </Select>
